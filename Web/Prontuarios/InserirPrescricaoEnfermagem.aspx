<%@ Page Title="Inserir Prescrição Enfermagem" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InserirPrescricaoEnfermagem.aspx.cs" Inherits="Web.Prontuarios.InserirPrescricaoEnfermagem" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br />
    <br />
    <h4>Inserir Prescrição Enfermagem</h4>
    <br />
    <p class="text-danger">
    ...
    <br />
    <asp:GridView ID="GridViewPrescricaoEnfermagem" runat="server" BackColor="White" BorderColor="#3366CC"
        BorderStyle="None" BorderWidth="1px" CellPadding="4" AutoGenerateColumns="False" Height="48px" AllowPaging="True" OnPageIndexChanging="GridViewPrescricaoEnfermagem_PageIndexChanging" PageSize="5">
        <Columns>
    ...
    <div class="row">
        ...
        <div class="col-xs-2">
            ...
            <asp:TextBox runat="server" ID="TextBoxHoraInicial" onkeyup="formataHora(this,event);" CssClass="form-control" />
        </div>
    </div>
    <br />
