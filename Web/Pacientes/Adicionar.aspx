<%@ Page Title="Adicionar Paciente" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Adicionar.aspx.cs" Inherits="Web.Pacientes.Adicionar" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-xs-3">
            ...
            <asp:TextBox runat="server" ID="TextBoxCPF" MaxLength="14" name="cpf" onBlur="ValidarCPF(form.cpf);" onkeyup="formataCPF(this,event);" required="true" class="form-control" />
        </div>
        <div class="col-xs-3">
    ...
    <br />
    <h3>Informações para Internação</h3>
    <br />
    <div class="row">
        <div class="col-xs-5">
            <asp:Label runat="server">Responsável</asp:Label>
            <asp:TextBox runat="server" ID="TextBoxResp" class="form-control" />
        </div>
        <div class="col-xs-4">
            <asp:Label runat="server">RG</asp:Label>
            <asp:TextBox runat="server" ID="TextBoxRGResponsavel" class="form-control" />
        </div>
        <div class="col-xs-3">
            <asp:Label runat="server">Telefone</asp:Label>
            <asp:TextBox runat="server" ID="TextBoxTelefoneResponsavel" MaxLength="14" onkeyup="formataTelefone(this,event);" class="form-control" />
        </div>
        <div class="col-xs-3">
    ...
    <div>
        ...
        <%--<asp:Button runat="server" OnClick="ImprimirQRCode" Text="Imprimir QRCode" CssClass="btn btn-primary" />--%>
