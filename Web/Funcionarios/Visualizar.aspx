<%@ Page Title="Informações do Funcionário" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Visualizar.aspx.cs" Inherits="Web.Funcionarios.Visualizar" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-xs-3">
            ...
            <asp:TextBox runat="server" ID="TextBoxCEP" class="form-control" />
        </div>
        <div class="col-xs-3">
        ...
        <div class="col-xs-3">
            ...
            <asp:TextBox runat="server" ID="TextBoxDataAdmissao" class="form-control" />
        </div>
        <div class="col-xs-3">
