<%@ Page Title="Cadastro de Funcionário" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Adicionar.aspx.cs" Inherits="Web.Funcionarios.Adicionar" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-xs-3">
            ...
            <asp:TextBox runat="server" ID="TextBoxDataNasc" MaxLength="10" onkeyup="formataData(this,event);" required="true" class="form-control" />
        </div>
        <div class="col-xs-3">
            <asp:Label runat="server">Data Admissão</asp:Label>
            <asp:TextBox runat="server" ID="TextBoxDataAdmissao" MaxLength="10" onkeyup="formataData(this,event);" class="form-control" />
        </div>
        <div class="col-xs-3">
