<%@ Page Title="Cadastro de Profissional" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Adicionar.aspx.cs" Inherits="Web.Profissionais.Adicionar" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-xs-3">
            ...
            <asp:TextBox runat="server" ID="TextBoxCEP" required="true" class="form-control" />
        </div>
        <div class="col-xs-3">
        ...
        <div class="col-xs-3">
            ...
            <asp:TextBox runat="server" ID="TextBoxCPF" onkeyup="formataCPF(this, event)" required="true" class="form-control" />
        </div>
        <div class="col-xs-3">
            <asp:Label runat="server">Tel Fixo</asp:Label>
            <asp:TextBox runat="server" ID="TextBoxTelFixo" class="form-control" />
        </div>
        <div class="col-xs-3">
            <asp:Label runat="server">Tel Celular</asp:Label>
            <asp:TextBox runat="server" ID="TextBoxTelCel" class="form-control" />
        </div>
        <div class="col-xs-3">
            <asp:Label runat="server">Data Nascimento</asp:Label>
            <asp:TextBox runat="server" ID="TextBoxDataNasc" required="true" class="form-control" />
        </div>
        <div class="col-xs-3">
        ...
        <div class="col-xs-3">
            ...
            <asp:TextBox runat="server" ID="TextBoxDataAdmissao" required="true" class="form-control" />
        </div>
    </div>
    <br />
    <br />
    <div>
        ...
        <asp:Button runat="server" Text="Voltar" CssClass="btn btn-primary" />
    </div>
</asp:Content>
